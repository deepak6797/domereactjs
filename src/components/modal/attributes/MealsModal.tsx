...
import { useAddMeals } from "../../../hooks/meals.hook";
...
const MealsModal: React.FC<MealsModalProps> = ({
  visible,
  isPending,
  onClose,
  setVisible,
  ...
  const { mutateAsync: addMeals } = useAddMeals();

  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    const resData: Props = data as Props;
    try {
      await addMeals(resData);
      showSuccessMessage("Meals Created Successfully");
      setVisible(false);
    } catch (err) {
