...
import { useUpdateTransport } from "../../../hooks/transport.hook";
...
interface TransportUpdateModalProps {
  visible: boolean;
  isPending?: boolean;
  data?: any;
  onClose: () => void;
...
const TransportUpdateModal: React.FC<TransportUpdateModalProps> = ({
  visible,
  isPending,
  onClose,
  setVisible,
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    ...
    try {
      await updateTransport({ body: resData, id: id });
