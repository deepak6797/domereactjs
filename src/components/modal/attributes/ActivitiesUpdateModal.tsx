...
import { useUpdateActivities } from "../../../hooks/activities.hook";
...
interface ActivitiesUpdateModalProps {
  visible: boolean;
  isPending?: boolean;
  data?: any;
  onClose: () => void;
...
const ActivitiesUpdateModal: React.FC<ActivitiesUpdateModalProps> = ({
  visible,
  isPending,
  onClose,
  setVisible,
  ...
  const { mutateAsync: updateActivities } = useUpdateActivities();

  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    const resData: Props = data as Props;
    try {
      await updateActivities({ body: resData, id: id });
