...
import { useUpdateTourType } from "../../../hooks/tourtype.hook";
...
interface TourTypeUpdateModalProps {
  visible: boolean;
  isPending?: boolean;
  data?: any;
  onClose: () => void;
...
const TourTypeUpdateModal: React.FC<TourTypeUpdateModalProps> = ({
  visible,
  isPending,
  onClose,
  setVisible,
  ...
  const { mutateAsync: updateTourType } = useUpdateTourType();

  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    const resData: Props = data as Props;
    try {
      await updateTourType({ body: resData, id: id });
      showSuccessMessage("tourType updated successfully !!!");
      setVisible(false);
    } catch (err) {
...
export default TourTypeUpdateModal;
