...
import { useAddAgeRange } from "../../../hooks/agerange.hook";
...
const AgeRangeModal: React.FC<AgeRangeModalProps> = ({
  visible,
  isPending,
  onClose,
  setVisible,
  ...
  const { mutateAsync: addAgeRange } = useAddAgeRange();

  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    const resData: Props = data as Props;
    try {
      await addAgeRange(resData);
      showSuccessMessage("ageRange added Successfully !!!");
      setVisible(false);
    } catch (err) {
